...
const DashboardAlbum = () => {
  ...
  return (
    <div className="w-full p-4 flex items-center flex-col">
      <div className="relative w-full gap-2 p-4 border border-gray-300 rounded-md flex flex-wrap">
        {allAlbums &&
...
export const AlbumCard = ({ data, index }) => {
  ...
  return (
    <motion.div
      ...
      className="relative  overflow-hidden w-44 min-w-180 px-2 py-2 gap-3 cursor-pointer hover:shadow-xl hover:bg-card bg-gray-100 shadow-md rounded-lg flex flex-col items-center"
    >
      <img
        src={data?.imageURL}
      ...
      {isDelete && (
        ...
        >
          ...
          <div className="flex items-center w-full justify-center gap-3">
            ...
            >
              <p className="text-headingColor text-sm">Hủy</p>
            </div>
          </div>
        </motion.div>
      )}
