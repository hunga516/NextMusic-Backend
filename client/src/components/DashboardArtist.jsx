...
const DashboardArtist = () => {
  ...
  return (
    <div className="w-full p-4 flex items-center flex-col">
      <div className="relative w-full gap-3 p-4 border border-gray-300 rounded-md flex flex-wrap">
        {artists &&
...
export const ArtistCard = ({ data, index }) => {
  ...
  return (
    <motion.div
      ...
      className="relative w-44 min-w-180 px-2 py-2 gap-2 cursor-pointer hover:shadow-xl hover:bg-card bg-gray-100 shadow-md rounded-lg flex flex-col items-center"
    >
      <img
        src={data?.imageURL}
