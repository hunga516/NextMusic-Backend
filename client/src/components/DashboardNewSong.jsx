      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 w-full">
        <div className="flex flex-col items-center justify-center gap-4">
          ...
          <div className="flex w-full flex-wrap items-center gap-4">
            ...
            <FilterButtons filterData={filters} flag={"Doanh mục"} />
          </div>

          <div className="flex items-center justify-between gap-2 w-full flex-wrap">
            <div className=" flex-[50%] bg-card  backdrop-blur-md w-full lg:w-300 h-300 rounded-md border-2 border-dotted border-gray-300 cursor-pointer">
            ...
            <div className="flex items-center justify-end w-full p-4">
              {isImageLoading || isAudioLoading ? (
                ...
                <motion.button
                  whileTap={{ scale: 0.75 }}
                  className="px-6 py-2 rounded-md text-white bg-red-600 hover:shadow-lg"
                  onClick={saveSong}
                >
                  upload
                </motion.button>
